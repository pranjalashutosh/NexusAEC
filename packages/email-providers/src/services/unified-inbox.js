        ...
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              Promise.all(
                Array.from(this.providers.entries()).map(function (_a) {
        ...
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              Promise.all(
                Array.from(this.providers.values()).map(function (p) {
                  return p.disconnect();
                })
              ),
            ];
  ...
  UnifiedInboxService.prototype.fetchUnread = function (filters, pagination) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          this.fetchEmailsFromAll(function (provider, pag) {
            return provider.fetchUnread(filters, pag);
          }, pagination),
        ];
      });
    });
                    ...
                    return __generator(this, function (_c) {
                      switch (_c.label) {
                        case 0:
                          ...
                          return [
                            4 /*yield*/,
                            provider.fetchThreads(filters, { pageSize: pageSize }),
                          ];
                        case 1:
                          response = _c.sent();
                        ...
                        case 2:
                          error_1 = _c.sent();
                          if (!this.config.continueOnError) throw error_1;
  ...
  UnifiedInboxService.prototype.fetchEmail = function (emailId) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        if (!provider) return [2 /*return*/, null];
  ...
  UnifiedInboxService.prototype.markRead = function (emailIds) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          this.routeToProviders(emailIds, function (provider, ids) {
            return provider.markRead(ids);
          }),
        ];
      });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          this.routeToProviders(emailIds, function (provider, ids) {
            return provider.markUnread(ids);
          }),
        ];
      });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          this.routeToProviders(emailIds, function (provider, ids) {
            return provider.flagEmails(ids);
          }),
        ];
      });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          this.routeToProviders(emailIds, function (provider, ids) {
            return provider.unflagEmails(ids);
          }),
        ];
      });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          this.routeToProviders(emailIds, function (provider, ids) {
            return provider.archiveEmails(ids);
          }),
        ];
      });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          this.routeToProviders(emailIds, function (provider, ids) {
            return provider.deleteEmails(ids);
          }),
        ];
      });
    });
        ...
        switch (_b.label) {
                  ...
                  return __awaiter(_this, [_a], void 0, function (_b) {
                    ...
                    return __generator(this, function (_c) {
                      switch (_c.label) {
                        ...
                        case 2:
                          error_2 = _c.sent();
                          if (!this.config.continueOnError) throw error_2;
          ...
          case 1:
            ...
            return [
              2 /*return*/,
              __assign(
                { items: results.slice(0, pageSize), errors: errors },
                results.length > pageSize && { nextPageToken: 'has-more' }
              ),
            ];
        }
                  ...
                  return __awaiter(_this, [_a], void 0, function (_b) {
                    ...
                    return __generator(this, function (_c) {
                      switch (_c.label) {
                        ...
                        case 2:
                          error_3 = _c.sent();
                          if (!this.config.continueOnError) throw error_3;
                    ...
                    return __generator(this, function (_c) {
                      switch (_c.label) {
                        case 0:
                          ...
                          return [
                            4 /*yield*/,
                            provider.fetchCalendarEvents(filters, { pageSize: pageSize }),
                          ];
                        case 1:
                          response = _c.sent();
                          results.push.apply(results, response.items);
                        ...
                        case 2:
                          error_4 = _c.sent();
                          if (!this.config.continueOnError) throw error_4;
        ...
        switch (_b.label) {
                  ...
                  return __awaiter(_this, [_a], void 0, function (_b) {
                    ...
                    return __generator(this, function (_c) {
                      switch (_c.label) {
                        ...
                        case 2:
                          error_5 = _c.sent();
                          if (!this.config.continueOnError) throw error_5;
          ...
          case 1:
            ...
            deduped = results.filter(function (c) {
              var _a;
              var primaryEmail =
                (_a = c.emailAddresses[0]) === null || _a === void 0 ? void 0 : _a.email;
            ...
            return [
              2 /*return*/,
              __assign(
                { items: deduped.slice(0, pageSize), errors: errors },
                  ...
                  return __awaiter(_this, [_a], void 0, function (_b) {
                    ...
                    return __generator(this, function (_c) {
                      switch (_c.label) {
                        ...
                        case 2:
                          error_6 = _c.sent();
                          if (!this.config.continueOnError) throw error_6;
                  ...
                  return __awaiter(_this, [_a], void 0, function (_b) {
                    ...
                    return __generator(this, function (_c) {
                      switch (_c.label) {
                        ...
                        case 2:
                          error_7 = _c.sent();
                          if (!this.config.continueOnError) throw error_7;
        ...
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              Promise.all(
                Array.from(byProvider.entries()).map(function (_a) {
                  return __awaiter(_this, [_a], void 0, function (_b) {
                    ...
                    return __generator(this, function (_c) {
                      switch (_c.label) {
                        ...
                        case 3:
                          error_8 = _c.sent();
                          if (!this.config.continueOnError) throw error_8;
