...
var RAGRetriever = /** @class */ (function () {
    function RAGRetriever(options) {
        ...
        this.defaultMinSimilarity = (_b = options.defaultMinSimilarity) !== null && _b !== void 0 ? _b : 0.7;
    ...
    RAGRetriever.prototype.retrieve = function (query_1) {
        return __awaiter(this, arguments, void 0, function (query, options) {
            var startTime, queryEmbedding, topK, minSimilarity, sourceType, searchResults, results, queryTime, error_1, err;
            var _a, _b;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        minSimilarity = (_b = options.minSimilarity) !== null && _b !== void 0 ? _b : this.defaultMinSimilarity;
                        sourceType = options.sourceType
                            ? options.sourceType.toUpperCase()
                            : undefined;
                        // Search vector store
                        if (this.debug) {
                            console.log("[RAGRetriever] Searching with topK=".concat(topK, ", minSimilarity=").concat(minSimilarity, ", sourceType=").concat(sourceType !== null && sourceType !== void 0 ? sourceType : 'all'));
                        }
                        return [4 /*yield*/, this.vectorStore.search(queryEmbedding, {
                                limit: topK,
                    ...
                    case 3:
                        ...
                        results = searchResults.map(function (result) { return ({
                        ...
                        if (this.debug) {
                            console.log("[RAGRetriever] Found ".concat(results.length, " results in ").concat(queryTime, "ms"));
                        }
    ...
    RAGRetriever.prototype.retrieveAssets = function (query_1) {
        return __awaiter(this, arguments, void 0, function (query, options) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.retrieve(query, __assign(__assign({}, options), { sourceType: 'asset' }))];
                    case 1:
                        results = _a.sent();
                        return [2 /*return*/, results];
                }
    ...
    RAGRetriever.prototype.retrieveSafetyDocuments = function (query_1) {
        return __awaiter(this, arguments, void 0, function (query, options) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.retrieve(query, __assign(__assign({}, options), { sourceType: 'safety_manual' }))];
                    case 1:
                        results = _a.sent();
                        return [2 /*return*/, results];
                }
