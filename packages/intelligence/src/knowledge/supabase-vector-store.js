            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, data.map(function (row) { return row.id; })];
                    case 2:
                        error_2 = _b.sent();
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        results = data.map(function (row) { return ({
                            document: {
                                id: row.id,
                                content: row.content,
                        ...
                        if (options.metadataFilter) {
                            results = results.filter(function (result) {
                                return _this.matchesMetadataFilter(result.document.metadata, options.metadataFilter);
                            });
                        }
                        if (this.debug) {
                            console.log("[SupabaseVectorStore] Found ".concat(results.length, " similar documents"));
                        }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (this.debug) {
                            console.log("[SupabaseVectorStore] Deleted ".concat(count !== null && count !== void 0 ? count : ids.length, " documents"));
                        }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (this.debug) {
                            console.log("[SupabaseVectorStore] Deleted ".concat(count !== null && count !== void 0 ? count : 0, " documents of type ").concat(sourceType));
                        }
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        if (options.offset) {
                            query = query.range(options.offset, options.offset + ((_b = options.limit) !== null && _b !== void 0 ? _b : 10) - 1);
                        }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (this.debug) {
                            console.log("[SupabaseVectorStore] Cleared ".concat(count !== null && count !== void 0 ? count : 0, " documents"));
                        }
                        return [2 /*return*/, count !== null && count !== void 0 ? count : 0];
                    case 2:
                        error_10 = _b.sent();
