...
var RateLimiter = /** @class */ (function () {
    ...
    RateLimiter.prototype.refill = function () {
        ...
        if (elapsedMinutes > 0) {
            // Refill requests
            this.requestTokens = Math.min(this.requestsPerMinute, this.requestTokens + this.requestsPerMinute * elapsedMinutes);
            // Refill tokens
            this.completionTokens = Math.min(this.tokensPerMinute, this.completionTokens + this.tokensPerMinute * elapsedMinutes);
            this.lastRefill = now;
        }
    };
    /**
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        ...
                                        requestWaitMs = this_1.requestTokens < 1 ? (1 - this_1.requestTokens) * (60000 / this_1.requestsPerMinute) : 0;
                                        tokenWaitMs = this_1.completionTokens < estimatedTokens
                                            ? (estimatedTokens - this_1.completionTokens) * (60000 / this_1.tokensPerMinute)
                                            : 0;
...
var LLMClient = /** @class */ (function () {
    function LLMClient(options) {
        ...
        this.defaultTemperature = (_b = options.defaultTemperature) !== null && _b !== void 0 ? _b : 0.7;
        ...
        this.retryOptions = {
            maxRetries: (_f = (_e = options.retry) === null || _e === void 0 ? void 0 : _e.maxRetries) !== null && _f !== void 0 ? _f : 3,
            initialRetryDelay: (_h = (_g = options.retry) === null || _g === void 0 ? void 0 : _g.initialRetryDelay) !== null && _h !== void 0 ? _h : 1000,
            maxRetryDelay: (_k = (_j = options.retry) === null || _j === void 0 ? void 0 : _j.maxRetryDelay) !== null && _k !== void 0 ? _k : 60000,
            backoffMultiplier: (_m = (_l = options.retry) === null || _l === void 0 ? void 0 : _l.backoffMultiplier) !== null && _m !== void 0 ? _m : 2,
        };
    }
    /**
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        temperature = (_b = options.temperature) !== null && _b !== void 0 ? _b : this.defaultTemperature;
                        maxTokens = (_c = options.maxTokens) !== null && _c !== void 0 ? _c : this.defaultMaxTokens;
                        if (this.debug) {
                            console.log("[LLMClient] Generating completion with model: ".concat(model));
                        }
                        estimatedPromptTokens = messages.reduce(function (sum, msg) { return sum + Math.ceil(msg.content.length / 4); }, 0);
                            ...
                            return __generator(this, function (_h) {
                                switch (_h.label) {
                                    ...
                                    case 1:
                                        ...
                                        if (this.debug) {
                                            console.log("[LLMClient] Completion generated: ".concat(result.totalTokens, " tokens in ").concat(result.responseTimeMs, "ms"));
                                        }
        ...
        return __awaiter(this, arguments, void 0, function (messages, onChunk, options) {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    // Execute with retry
                    return [2 /*return*/, this.executeWithRetry(function () { return __awaiter(_this, void 0, void 0, function () {
                            var startTime, fullContent, finishReason, stream, _a, stream_1, stream_1_1, chunk, delta, e_1_1, responseTimeMs, promptTokens, completionTokens, totalTokens, result;
                            var _b, e_1, _c, _d;
                            var _e, _f;
                            return __generator(this, function (_g) {
                                switch (_g.label) {
                                    ...
                                    case 4:
                                        ...
                                        _a = false;
                                        chunk = _d;
                                        delta = (_e = chunk.choices[0]) === null || _e === void 0 ? void 0 : _e.delta;
                                        if (!(delta === null || delta === void 0 ? void 0 : delta.content)) return [3 /*break*/, 6];
                                    ...
                                    case 5:
                                        ...
                                        _g.label = 6;
                                    case 6:
                                        if ((_f = chunk.choices[0]) === null || _f === void 0 ? void 0 : _f.finish_reason) {
                                    ...
                                    case 15:
                                        ...
                                        if (this.debug) {
                                            console.log("[LLMClient] Streaming completion generated: ~".concat(result.totalTokens, " tokens in ").concat(result.responseTimeMs, "ms"));
                                        }
                                        return [2 /*return*/, result];
                                }
                            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        if (this.debug) {
                            console.log("[LLMClient] Retry ".concat(attempt + 1, "/").concat(this.retryOptions.maxRetries, " after ").concat(retryDelay, "ms: ").concat(lastError.message));
                        }
    ...
    LLMClient.prototype.isRetryableError = function (error) {
        ...
        return retryablePatterns.some(function (pattern) { return message.includes(pattern); });
    };
    /**
