...
function findVipMatch(email, vipList) {
  ...
  return vipList.find(function (vip) {
    return normalizeEmail(vip.email) === normalized;
  });
}
/**
...
function findContact(email, contacts) {
  ...
  return contacts.find(function (contact) {
    return normalizeEmail(contact.email) === normalized;
  });
}
/**
...
function hasVipJobTitle(jobTitle) {
  ...
  return vipTitles.some(function (title) {
...
var VipDetector = /** @class */ (function () {
  function VipDetector(config, options) {
    ...
    this.options = {
      ...
      highInteractionThreshold:
        (_d = options.highInteractionThreshold) !== null && _d !== void 0 ? _d : 50,
      mediumInteractionThreshold:
        (_e = options.mediumInteractionThreshold) !== null && _e !== void 0 ? _e : 20,
      highInteractionWeight:
        (_f = options.highInteractionWeight) !== null && _f !== void 0 ? _f : 0.6,
      mediumInteractionWeight:
        (_g = options.mediumInteractionWeight) !== null && _g !== void 0 ? _g : 0.4,
      recencyBoostDays: (_h = options.recencyBoostDays) !== null && _h !== void 0 ? _h : 7,
      recencyBoostMultiplier:
        (_j = options.recencyBoostMultiplier) !== null && _j !== void 0 ? _j : 0.2,
    };
  }
  /**
  ...
  VipDetector.prototype.detectVip = function (email) {
    ...
    if (vipEntry) {
      ...
      reasons.push({
        type: 'explicit_vip',
        description: 'Sender is in VIP list: '.concat(
          (_a = vipEntry.name) !== null && _a !== void 0 ? _a : vipEntry.email
        ),
  ...
  VipDetector.prototype.removeVip = function (email) {
    var normalized = normalizeEmail(email);
    var index = this.vipList.findIndex(function (vip) {
      return normalizeEmail(vip.email) === normalized;
    });
    if (index !== -1) {
