...
var CalendarProximityDetector = /** @class */ (function () {
  function CalendarProximityDetector(config, options) {
    ...
    this.options = {
      ...
      attendeeOverlapWeight:
        (_e = options.attendeeOverlapWeight) !== null && _e !== void 0 ? _e : 0.8,
      organizerMatchWeight:
        (_f = options.organizerMatchWeight) !== null && _f !== void 0 ? _f : 0.9,
      contentSimilarityThreshold:
        (_g = options.contentSimilarityThreshold) !== null && _g !== void 0 ? _g : 0.3,
    };
  }
  /**
    ...
    for (var _i = 0, eventsInWindow_1 = eventsInWindow; _i < eventsInWindow_1.length; _i++) {
      ...
      if (timeScore > 0) {
        ...
        eventReasons.push({
          type: 'time_proximity',
          description: 'Event "'
            .concat(event_1.title, '" in ')
            .concat(Math.round(hoursToEvent), ' hours'),
          weight: timeWeight,
          eventId: event_1.id,
        });
      }
      // 2. Content matching
      var eventText = ''
        .concat(event_1.title, ' ')
        .concat((_c = event_1.description) !== null && _c !== void 0 ? _c : '', ' ')
        .concat((_d = event_1.location) !== null && _d !== void 0 ? _d : '');
      ...
      // 3. Attendee overlap
      var attendeeEmails = event_1.attendees.map(function (a) {
  ...
  CalendarProximityDetector.prototype.addEvent = function (event) {
    ...
    var existing = this.upcomingEvents.find(function (e) {
  ...
  CalendarProximityDetector.prototype.removeEvent = function (eventId) {
    var index = this.upcomingEvents.findIndex(function (e) {
      return e.id === eventId;
    });
    if (index !== -1) {
