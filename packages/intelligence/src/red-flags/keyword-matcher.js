...
function levenshteinDistance(str1, str2) {
  ...
  var matrix = Array.from({ length: len1 + 1 }, function () {
    return Array.from({ length: len2 + 1 }, function () {
      return 0;
    });
  });
...
function extractFieldValue(email, field) {
  ...
  switch (field) {
    ...
    case 'body':
      return (_c = (_b = email.body) !== null && _b !== void 0 ? _b : email.snippet) !== null &&
        _c !== void 0
        ? _c
        : '';
    case 'sender':
      return ''
        .concat((_d = email.from.name) !== null && _d !== void 0 ? _d : '', ' ')
...
var KeywordMatcher = /** @class */ (function () {
  function KeywordMatcher(options) {
    ...
    this.options = {
      ...
      patterns:
        (_d = options.patterns) !== null && _d !== void 0
          ? _d
  ...
  KeywordMatcher.prototype.matchEmail = function (email) {
    ...
    var aggregateWeight = Array.from(uniquePatternIds).reduce(function (sum, patternId) {
      var _a;
      var pattern = _this.options.patterns.find(function (p) {
        return p.id === patternId;
      });
      return (
        sum +
        ((_a = pattern === null || pattern === void 0 ? void 0 : pattern.weight) !== null &&
        _a !== void 0
          ? _a
          : 0)
      );
  ...
  KeywordMatcher.prototype.addPatterns = function (patterns) {
    this.options.patterns = __spreadArray(
      __spreadArray([], this.options.patterns, true),
      patterns,
      true
    );
  };
