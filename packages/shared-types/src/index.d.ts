...
export type AuditActionType = 'mark_read' | 'mark_unread' | 'move_to_folder' | 'apply_label' | 'create_draft' | 'send_draft' | 'flag_followup' | 'mute_sender' | 'add_vip' | 'remove_vip' | 'undo';
