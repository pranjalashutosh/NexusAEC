...
function testVectorStore() {
    return __awaiter(this, void 0, void 0, function () {
        var openai, embeddingGenerator, vectorStore, testContent, embedding, testDoc, queryEmbedding, results, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    testContent = 'Pump Station P-104 is located at Riverside Bridge. It handles main water distribution for the district.';
                    // Generate embedding
                ...
                case 4:
                    ...
                    return [4 /*yield*/, vectorStore.search(queryEmbedding, {
                            limit: 3,
                            minSimilarity: 0.5,
                        })];
                case 5:
                    ...
                    results.forEach(function (result, idx) {
                        console.log("   ".concat(idx + 1, ". Score: ").concat(result.similarity.toFixed(3), " | ").concat(result.document.content.substring(0, 100), "..."));
                        console.log("      Metadata: ".concat(JSON.stringify(result.document.metadata)));
                    });
                    return [2 /*return*/, { vectorStore: vectorStore, embeddingGenerator: embeddingGenerator }];
                case 6:
                    error_1 = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, ragRetriever.retrieve('Tell me about pump maintenance', {
                            topK: 3,
                            minSimilarity: 0.6,
                            sourceType: 'asset',
                        })];
                case 2:
                    ...
                    context.forEach(function (chunk, idx) {
                        console.log("   ".concat(idx + 1, ". [").concat(chunk.sourceType, "] Score: ").concat(chunk.score.toFixed(3)));
...
function testRedFlagDetection() {
    return __awaiter(this, void 0, void 0, function () {
        var mockEmails, keywordMatcher, vipDetector, velocityCalculator, calendarScorer, redFlagScorer, redFlags, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    keywordMatcher = new keyword_matcher_1.KeywordMatcher(default_patterns_1.DEFAULT_RED_FLAG_PATTERNS);
                    vipDetector = new vip_detector_1.VIPDetector({
                        vips: [
                            { email: 'john.smith@example.com', name: 'John Smith', addedAt: new Date().toISOString() },
                        ],
                    });
                ...
                case 2:
                    ...
                    redFlags.forEach(function (flag) {
                        ...
                        console.log("   \uD83C\uDFAF Score: ".concat(flag.score.toFixed(3), " (threshold: ").concat(flag.threshold, ")"));
                        ...
                        console.log("   \uD83D\uDCA1 Reason: ".concat(flag.reason || 'Multiple high-priority signals detected'));
                    });
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    topics.forEach(function (topic) {
                        ...
                        console.log("   \uD83D\uDD52 Last activity: ".concat(new Date(topic.lastActivityAt).toLocaleString()));
                    });
                    return [3 /*break*/, 4];
                case 3:
                    error_4 = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, summarizer.summarizeThread(mockEmails.filter(function (e) { return e.threadId === 'thread-1'; }))];
                case 2:
                    summary = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, narrativeGen.generateBriefing({
                            topics: topics,
                            redFlags: redFlags,
...
function runTests() {
    return __awaiter(this, void 0, void 0, function () {
        var requiredEnvVars, allPresent, _i, requiredEnvVars_1, envVar, isPresent, vectorStoreResult, redFlagResult;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    for (_i = 0, requiredEnvVars_1 = requiredEnvVars; _i < requiredEnvVars_1.length; _i++) {
                        ...
                        log("".concat(isPresent ? '✅' : '❌', " ").concat(envVar), isPresent ? 'green' : 'red');
                        if (!isPresent)
                            allPresent = false;
                    }
                    if (!allPresent) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, testRAGRetrieval((vectorStoreResult === null || vectorStoreResult === void 0 ? void 0 : vectorStoreResult.vectorStore) || null, (vectorStoreResult === null || vectorStoreResult === void 0 ? void 0 : vectorStoreResult.embeddingGenerator) || null)];
                case 3:
                    _a.sent();
                ...
                case 6:
                    _a.sent();
                    return [4 /*yield*/, testNarrativeGeneration(redFlagResult.mockEmails, redFlagResult.redFlags)];
                case 7:
                    _a.sent();
                    _a.label = 8;
                case 8:
